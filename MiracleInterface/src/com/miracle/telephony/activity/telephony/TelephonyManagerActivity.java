package com.miracle.telephony.activity.telephony;
 ...
 * TelephonyManager类的对象可以通过Context.getSystemService(Context.TELEPHONY_SERVICE)
 * 方法来获得，需要注意的是有些通讯信息的获取对应用程序的权限有一定的限制，在开发的时候需要为其添加相应的权限。
...
public class TelephonyManagerActivity extends Activity {
	...
	public static void actionStart(Context context, int data1) {
		Intent intent = new Intent(context, TelephonyManagerActivity.class);
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.telephony_activity_telephony_manager);

		mTextView = (TextView) findViewById(R.id.txt_telephony_manager);
