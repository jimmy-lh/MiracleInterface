package com.miracle.expandable.activity.expandable;

import java.util.ArrayList;
import java.util.List;

import com.miracle.activity.R;
import com.miracle.expandable.view.expandable.PinnedHeaderExpandableListView;
import com.miracle.expandable.view.expandable.StickyLayout;
import com.miracle.expandable.view.expandable.PinnedHeaderExpandableListView.OnHeaderUpdateListener;
import com.miracle.expandable.view.expandable.StickyLayout.OnGiveUpTouchEventListener;
...
public class ExpandableActivity extends Activity implements ExpandableListView.OnChildClickListener,
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.expandable_activity_expandable);
	...
	class MyexpandableListAdapter extends BaseExpandableListAdapter {
		...
		public View getGroupView(int groupPosition, boolean isExpanded, View convertView, ViewGroup parent) {
			...
			if (isExpanded) // ture is Expanded or false is not isExpanded
				groupHolder.imageView.setImageResource(R.drawable.expandable_expanded);
			else
				groupHolder.imageView.setImageResource(R.drawable.expandable_collapse);
			return convertView;
		}
			...
			if (convertView == null) {
				...
				button.setOnClickListener(new OnClickListener() {
					...
					public void onClick(View v) {
						Toast.makeText(ExpandableActivity.this, "clicked pos=", Toast.LENGTH_SHORT).show();
					}
				});
	...
	public boolean onChildClick(ExpandableListView parent, View v, int groupPosition, int childPosition, long id) {
		Toast.makeText(ExpandableActivity.this, childList.get(groupPosition).get(childPosition).getName(), 1).show();
	...
	public View getPinnedHeader() {
		View headerView = (ViewGroup) getLayoutInflater().inflate(R.layout.expandable_group, null);
